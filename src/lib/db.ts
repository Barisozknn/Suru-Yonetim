...
import type { Hayvan, Grup, Yem, YemHareketi, SutKaydi, AgirlikKaydi, SaglikOlayi, AsiProtokolu, PlanlananAsi, UremeKaydi, BuzagiKaydi, Sohbet, EkFinansalIslem, GunlukYemMaliyeti, Todo, GunlukNotu } from '../types';
