      ...
      <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg border border-earth-200 dark:border-gray-700 max-w-md w-full">
        ...
        <>
          ...
          <form onSubmit={handleRegister} className="space-y-4">
              ...
              <div>
                <label className="block text-sm font-bold text-earth-700 dark:text-gray-300 mb-1">Şifre (En az 6 karakter)</label>
                <input
                  type="password"
                  value={password}
            ...
            Zaten hesabın var mı? <Link to="/login" className="text-nature-600 dark:text-nature-400 hover:underline">Giriş Yap</Link>
          </div>
        </>
      </div>
    </div>
